...
%
%  DESCRIPTION: Calculates the corresponding angle between 0 and 360 
%  degrees (or 0 and 2*pi radians) of an angle outside these limits (see 
%  also functions #wrapTo360, #wrapTo180, #wrapTo2Pi and #wrapToPi).
%
%  INPUT VARIABLES
