FFT Filtering (Single)
=======================

MATLAB code for designing and applying a single filter. Calculations
are done in the frequency domain using the Fast Fourier Transform (FFT).
